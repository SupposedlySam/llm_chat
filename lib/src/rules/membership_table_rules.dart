...
MembershipTableRules main() => MembershipTableRules();
...
final class MembershipTableRules extends TableRules<MembershipTable, Membership> {
  MembershipTableRules() : super(memberships);
